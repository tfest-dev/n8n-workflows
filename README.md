...
| `sales-pipeline-enrichment/` | Enriches new leads with firmographic, technology, behavioural and CRM-history signals, applies deterministic scoring, prepares optional LLM qualification wording, and routes sales-ready leads to the correct channel. Useful where response speed and lead quality depend on manual research. | `sales-pipeline-enrichment/sales-pipeline-enrichment.json` |
